...
import CourseExplain from "./components/CourseExplain";
...
import CourseUpdDel from './components/adminPages/CourseDelUpd';
      ...
      <ToastContainer position="top-center"/>
        <div className={AppStyle.MainDiv}>
          <Routes>
            ...
            <Route path="/Course/CourseExplain/:id"element={<CourseExplain />}/>
            <Route path="/notfound" element={<NotFound />} />
            <Route path="/*" element={<Navigate to="/notfound" />} />
            <Route path="/login" element={<Login />} />
            <Route path="/users" element={<Users />} />
            <Route path="/CourseAdmin/*" element={<CourseAdmin />} >
                <Route path="CourseDelUpd" element={<CourseUpdDel />}/>
