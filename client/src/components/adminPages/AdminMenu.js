...
const AdminMenu = () => {
    ...
    return (
        ...
        <div className={Style.menuItem}>
            <img alt="مدیریت کاربران" className={Style.homeIconPic} src={userPic} title="مدیریت کاربران" />
            <label>مدیریت کاربران</label>
        </div>
        </Link>
        <Link to='/CourseAdmin'>
            <div className={Style.menuItem}>
                <img alt="مدیریت دوره ها" className={Style.homeIconPic} src={coursePic} title="مدیریت دوره ها" />
                <label>مدیریت دوره ها</label>
            </div>
        </Link>
        <Link to='/'>
            <div className={Style.buttoncontainer}><button onClick={clickHandler}>خروج</button></div>
        </Link>
    </div>
    );
};
