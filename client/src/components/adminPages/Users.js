...
import { getUsers , deleteUser , updateUser , insertUser } from '../../services/userApi';
//context
...
//Handler Function
  ...
  const ChangeHandlerUpdateUser = (event) =>{
    setSelectedUserData({...SelectedUserData, [event.target.name]: event.target.value})
  }
/////////////////////////////////////////////////////////////////
//Insert New User
        ...
        <div className={Styles.Container}>
            <div className={Styles.UserManage}>
              <div className={Styles.AddUser}>
                ...
                <input name='username' type="text" onChange={ChangeHandlerNewUser} value={NewUserData.username}></input>
                <label>رمز عبور</label>
                <input name='password' type="text" onChange={ChangeHandlerNewUser} value={NewUserData.password}></input>
                <button onClick={InsertNewUserHandler}>ثبت کاربر جدید</button>
              </div>
              
              <div className={Styles.UpdateUser}>
                <div className={Styles.UpdateUserUpSectin}>
                  <label>نام کاربری جدید</label>
                  <input type="text" name='username' onChange={ChangeHandlerUpdateUser} value={SelectedUserData.username}></input>
                  <label>رمز عبور جدید</label>
                  <input type="text" name='password' onChange={ChangeHandlerUpdateUser} value={SelectedUserData.password}></input>
                </div>
                <div className={Styles.UpdateUserDownSection}>
                  <button onClick={() => {deleteUserHandler(SelectedUserData.id)}}>حذف</button>
                  <button onClick={UpdateUserHandler}>به روز رسانی</button>
                </div>
              </div>
            </div>
          <div className={Styles.UserShowContainer}>
            {UserData.map((item) => (
              <div key={item.id} className={Styles.ContainerUser} onClick={() => {SelectUserHandler(item)}}>
