                ...
                <div className={AboutUsStyle.LeftSide}>
                    <div className={AboutUsStyle.contentAbout}>
                        <div className={AboutUsStyle.selectorAbout}>
                            <Link to="Tahsil"><button className={AboutUsStyle.aboutSelectorItem}>سوابق تحصیلی</button></Link>
                            <Link to="Pazhouhesh"><button className={AboutUsStyle.aboutSelectorItem}>سوابق پژوهشی</button></Link>
                            <Link to="Darman"><button className={AboutUsStyle.aboutSelectorItem}>سوابق درمانی</button></Link>                        <Link to="Amouzesh"><button className={AboutUsStyle.aboutSelectorItem}>سوابق آموزشی</button></Link>
                            <Link to="Ejra"><button className={AboutUsStyle.aboutSelectorItem}>سوابق اجرایی</button></Link>
                        </div>
